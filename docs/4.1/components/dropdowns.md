...
If you're building our JavaScript from source, it [requires `util.js`]({{ site.baseurl }}/getting-started/javascript/#util).
...
Place any freeform text within a dropdown menu with text and use [spacing utilities]({{ site.baseurl }}/utilities/spacing/). Note that you'll likely need additional sizing styles to constrain the menu width.
...
Put a form within a dropdown menu, or make it into a dropdown menu, and use [margin or padding utilities]({{ site.baseurl }}/utilities/spacing/) to give it the negative space you require.
